  ...
  return (
    <div className="profile h-full lg:w-[42rem] xl:w-[48rem] bg-gray-900 rounded-lg relative lg:block hidden">
      <div className="relative z-40 w-full h-full myShadow">
        ...
        <h1 className="text-center text-gray-300 text-[3.4rem] font-extrabold mt-4 mb-0.5 font-serif tracking-tight">
          {profileData.name}
        </h1>
        ...
        <div className="absolute bottom-0 left-0 flex w-full h-28 borderLeft customLine">
          ...
          <MyLink
            name="my linkedin"
            Icon={AiFillLinkedin}
            url="https://www.linkedin.com/in/david-chen-a8b198392/"
          />
        </div>
      </div>
    </div>
